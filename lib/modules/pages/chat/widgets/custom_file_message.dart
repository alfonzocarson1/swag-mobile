...
class CustomFileMessage extends StatefulWidget {
  const CustomFileMessage({super.key, required this.fileUrl, required this.mediaType});
...
class _CustomFileMessageState extends State<CustomFileMessage> {
  ...
  Widget build(BuildContext context) {
    ...
    return     Center(
      ...
      (widget.fileUrl.isEmpty) ? CircularProgressIndicator() :
      CachedNetworkImage(
      ...
      :IconButton(
        ...
        onPressed: () {
         ...
         Navigator.of(context).push(MaterialPageRoute(builder: (context) => MediaViewerPage(url: widget.fileUrl) ,));
         }
        },
      ),
    );
