...
class EditMultiPaymentDropdown extends StatefulWidget {
  ...
  @override
  _EditMultiPaymentDropdownState createState() =>
      _EditMultiPaymentDropdownState();
}

class _EditMultiPaymentDropdownState extends State<EditMultiPaymentDropdown> {
  ...
  void addPaymentIfNotNull(String? payment, String itemName) {
    if (payment != null &&
        payment.isNotEmpty &&
        !connectedMethods.contains(itemName)) {
      connectedMethods.add(itemName);
    }
  }

  void selectAllConnectedMethods() {
    for (final m in widget.paymentAccepted) {
