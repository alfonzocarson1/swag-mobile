...
GetCollectionModel _$GetCollectionModelFromJson(Map<String, dynamic> json) {
  return _GetCollectionModel.fromJson(json);
}

/// @nodoc
mixin _$GetCollectionModel {
  ...
  @JsonKey(ignore: true)
  $GetCollectionModelCopyWith<GetCollectionModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetCollectionModelCopyWith<$Res> {
  factory $GetCollectionModelCopyWith(
          GetCollectionModel value, $Res Function(GetCollectionModel) then) =
      _$GetCollectionModelCopyWithImpl<$Res, GetCollectionModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GetCollectionModelCopyWithImpl<$Res, $Val extends GetCollectionModel>
    implements $GetCollectionModelCopyWith<$Res> {
  _$GetCollectionModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_GetCollectionModelCopyWith<$Res>
    implements $GetCollectionModelCopyWith<$Res> {
  factory _$$_GetCollectionModelCopyWith(_$_GetCollectionModel value,
          $Res Function(_$_GetCollectionModel) then) =
      __$$_GetCollectionModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String catalogItemId,
...
/// @nodoc
class __$$_GetCollectionModelCopyWithImpl<$Res>
    extends _$GetCollectionModelCopyWithImpl<$Res, _$_GetCollectionModel>
    implements _$$_GetCollectionModelCopyWith<$Res> {
  __$$_GetCollectionModelCopyWithImpl(
      _$_GetCollectionModel _value, $Res Function(_$_GetCollectionModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_GetCollectionModel(
      catalogItemId: null == catalogItemId
          ? _value.catalogItemId
          : catalogItemId // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_GetCollectionModel implements _GetCollectionModel {
  ...
  factory _$_GetCollectionModel.fromJson(Map<String, dynamic> json) =>
      _$$_GetCollectionModelFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_GetCollectionModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_GetCollectionModelCopyWith<_$_GetCollectionModel> get copyWith =>
      __$$_GetCollectionModelCopyWithImpl<_$_GetCollectionModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GetCollectionModelToJson(
      this,
    );
  }
}

abstract class _GetCollectionModel implements GetCollectionModel {
  const factory _GetCollectionModel(
  ...
  factory _GetCollectionModel.fromJson(Map<String, dynamic> json) =
      _$_GetCollectionModel.fromJson;
