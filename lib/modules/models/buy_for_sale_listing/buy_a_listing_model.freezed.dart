...
class _$_BuyASaleListingModel implements _BuyASaleListingModel {
  ...
  @override
  String toString() {
    return 'BuyASaleListingModel(saveAddress: $saveAddress, productItemId: $productItemId, address: $address, profilePeerToPeerPayment: $profilePeerToPeerPayment)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, saveAddress, productItemId,
      address, profilePeerToPeerPayment);
