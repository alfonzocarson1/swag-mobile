...
DetailItemModel _$DetailItemModelFromJson(Map<String, dynamic> json) {
  return _DetailItemModel.fromJson(json);
}
...
/// @nodoc
abstract class $DetailItemModelCopyWith<$Res> {
  factory $DetailItemModelCopyWith(
          DetailItemModel value, $Res Function(DetailItemModel) then) =
      _$DetailItemModelCopyWithImpl<$Res, DetailItemModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DetailItemModelCopyWithImpl<$Res, $Val extends DetailItemModel>
    implements $DetailItemModelCopyWith<$Res> {
  _$DetailItemModelCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      attributeItemList: freezed == attributeItemList
          ...
          : attributeItemList // ignore: cast_nullable_to_non_nullable
              as List<DetailAttributeModel>?,
      myCollection: freezed == myCollection
          ? _value.myCollection
          : myCollection // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract class _$$_DetailItemModelCopyWith<$Res>
    implements $DetailItemModelCopyWith<$Res> {
  factory _$$_DetailItemModelCopyWith(
          _$_DetailItemModel value, $Res Function(_$_DetailItemModel) then) =
      __$$_DetailItemModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String catalogItemId,
...
/// @nodoc
class __$$_DetailItemModelCopyWithImpl<$Res>
    extends _$DetailItemModelCopyWithImpl<$Res, _$_DetailItemModel>
    implements _$$_DetailItemModelCopyWith<$Res> {
  __$$_DetailItemModelCopyWithImpl(
      _$_DetailItemModel _value, $Res Function(_$_DetailItemModel) _then)
      : super(_value, _then);
...
class _$_DetailItemModel implements _DetailItemModel {
  ...
  @override
  List<DetailAttributeModel>? get attributeItemList {
    final value = _attributeItemList;
    if (value == null) return null;
    if (_attributeItemList is EqualUnmodifiableListView)
      return _attributeItemList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<DetailCollectionModel>? _myCollection;
  @override
  List<DetailCollectionModel>? get myCollection {
    final value = _myCollection;
    if (value == null) return null;
    if (_myCollection is EqualUnmodifiableListView) return _myCollection;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._myCollection, _myCollection) &&
  ...
  _$$_DetailItemModelCopyWith<_$_DetailItemModel> get copyWith =>
      __$$_DetailItemModelCopyWithImpl<_$_DetailItemModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DetailItemModelToJson(
      this,
    );
  }
}
