...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(sellerUserName) =>
      "@${sellerUserName} has confirmed that payment has been received";

  static String m8(sellerUserName, buyerName, buyerLastName, address, address2,
          city, state, zipCode, country) =>
      "@${sellerUserName} here is the shipping address to ship this item\n\n${buyerName} ${buyerLastName}\n${address}, ${address2} \n${city}, ${state}, ${zipCode}, ${country}";

  static String m9(userName) => "@${userName} has started a chat";

  static String m10(sender) => "New message from ${sender}";

  static String m11(buyerUserName) =>
      "Payment Confirmation @${buyerUserName} indicated they made payment";

  static String m12(sellerUserName, trackingNumber) =>
      "@${sellerUserName} has shipped the item. Here is the tracking number\n\n${trackingNumber}";

  static String m13(sellerUserName) =>
      "@${sellerUserName} has shipped the item.";

  static String m14(chatsNumber) => "${chatsNumber} Unread";

  static String m15(itemName, userName) =>
      "It’s been 7 days since you purchased the ${itemName} from @${userName}. We want to know if you received your item yet?";

  static String m16(number) => "${number} Items";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "chatCardConfirmPaymentBuyer": m4,
        "chatCardConfirmPaymentSeller": m5,
        "chatCardPaymentReceivedSeller": m6,
        ...
        "chatPaymentSendBuyer": m11,
        "chatShippedMessage": m12,
        "chatShippedMessageWithoutTrackingNumber": m13,
        ...
        "notDeliveredItemChatMessage": m17,
